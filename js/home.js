let productDataUrl =
    "https://my-json-server.typicode.com/pavan-kumar2/Swag_of_India-Home_page-Products_data/db";
        ...
        .then((data) => {
            ...
            productsData.forEach((product) => {
                ...
                if (product.isNew === "TRUE") {
                    isNewDiv =
                        '<div class="badge-new"><span class="badge badge-secondary">New</span></div>';
                }
                ...
                cards =
                    cards +
                    `
                            <div class="col-md-4 col-6 card-box" tabindex="0" role="cell" aria-label="${
                              product.imageName
                            }">
                                <div class="card" id="${product.id}">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center flex-column">
                                        <img class="bd-placeholder-img card-img-top" src="images/${
                                          product.source
                                        }.png"
                                            alt="shorts" width="100%" height="80%" role="img">

                                        <div class="position-absolute row icons-view">
                                            <div class="col-4 p-0 wishlist" onclick="wishlist.addToWishlist('${encodeURI(
                                              JSON.stringify(product)
                                            )}')"><img src="images/Group 2579.png" alt="wishlist"></div>
                                            <div class="col-4 p-0 view" onclick="productView.addToProductView('${encodeURI(
                                              JSON.stringify(product)
                                            )}')"><a href="./product_view.html"><img src="images/Group 2580.png" alt="view"></a></div>
                                            <div class="col-4 p-0 cart" onclick="cart.addToCart('${encodeURI(
                                              JSON.stringify(product)
