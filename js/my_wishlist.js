function renderWishlistItem() {
        ...
        return (
            ...
            `<div class="row">
                            <div class="wishlist-item col-12 d-flex p-0">
                                <div class="item-img"><img src="./images/${
                                  curr.source
                                }.png" alt="${curr.imageName}"></div>
                                <div class="item-detail">
                                    ...
                                    <div class="addcart-removewishlist">
                                        <span><button class="addcart-btn" onclick="moveToCart('${
                                          curr.id
                                        }', '${encodeURI(
        JSON.stringify(curr)
      )}')">Add to Cart</button></span>
                                        <span>|</span>
                                        <span onclick="removeWishlistItem('${
                                          curr.id
    ...
    document.getElementById("numberOfWishlisItems").innerHTML =
        wishlistItem.length;
}
